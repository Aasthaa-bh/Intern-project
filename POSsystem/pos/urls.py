...
urlpatterns = [
    ...
    path(
        "waiter/create-order/<str:order_type>/",
        views.create_order_by_type,
        name="create_order_by_type",
    ),
    ...
    path(
        ...
        views_category.category_create,
        name="category_create",
    ),
    path(
        "owner/categories/<int:category_id>/edit/",
        views_category.category_edit,
        name="category_edit",
    ),
    path(
        "owner/categories/<int:category_id>/delete/",
        views_category.category_delete,
    ...
    path(
        "owner/items/<int:item_id>/delete/", views_item.item_delete, name="item_delete"
    ),
    path(
        "owner/loyalty/settings/",
        views_loyalty.loyalty_settings,
        name="loyalty_settings",
    ),

    # Antim added
    path("items/add/", views_item.add_item, name="add_item"),
]
